        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow p-6">
              ...
              {/* Stats - един акаунт за всичко */}
              <div className="space-y-4">
                <div className="p-4 bg-blue-50 rounded-lg">
                  <h4 className="text-sm font-medium text-blue-900 mb-2">Публикувани задачи</h4>
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      <span className="text-blue-700">Публикувани:</span>
                      <span className="font-semibold">{user.taskGiver.totalTasksPosted}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-blue-700">Завършени:</span>
                ...
                <div className="p-4 bg-green-50 rounded-lg">
                  <h4 className="text-sm font-medium text-green-900 mb-2">Изпълнени задачи</h4>
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      <span className="text-green-700">Завършени:</span>
            ...
            <div className="bg-white rounded-lg shadow mb-6">
              ...
              <div className="p-6">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      ...
                      >
                        ...
                        <p className="text-sm text-blue-100">Получи оферти от потребители</p>
                      </button>
                      <button
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="bg-blue-50 rounded-lg p-6">
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <h4 className="text-lg font-medium text-blue-900">Публикувай задача</h4>
                        </div>
                        <p className="text-blue-700 mb-4">Публикувайте нова задача и получете оферти от квалифицирани потребители.</p>
                        <button
                          onClick={() => router.push('/post-task')}
                      ...
                      <div className="bg-green-50 rounded-lg p-6">
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <h4 className="text-lg font-medium text-green-900">Търси задачи</h4>
                        </div>
                        <p className="text-green-700 mb-4">Намерете задачи и кандидатствайте.</p>
                        <button
                          onClick={() => router.push('/tasks')}
                ...
                {activeTab === 'taskExecutor' && (
                  <div className="space-y-6">
                    <div className="flex justify-between items-center">
                      <h3 className="text-lg font-medium text-gray-900">Моите кандидатури</h3>
                      <button
                        onClick={() => router.push('/tasks')}
