...
const stats = [
  { label: 'Средна ставка', value: '18 €/ч.', description: 'за популярни услуги като монтаж, почистване и куриерски задачи.' },
  { label: 'Средно месечен доход', value: '650 €', description: 'при 3-4 задачи седмично с flex график.' },
