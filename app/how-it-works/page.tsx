...
const benefits = [
  ...
  },
  {
    ...
    description: 'Плащането се освобождава само след завършване на задачата',
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <p className="text-gray-600">
                Публикуването на задача е напълно безплатно. Плащате само когато изберете изпълнител и задачата бъде завършена.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <p className="text-gray-600">
                Всички изпълнители са проверени и имат положителни отзиви. Освен това, плащането се освобождава само след ваше одобрение.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <p className="text-gray-600">
                Да, можете да отмените задачата преди да изберете изпълнител без никакви такси. След избора на изпълнител се прилагат нашите условия за отмяна.
              </p>
            </div>
          </div>
        </div>
