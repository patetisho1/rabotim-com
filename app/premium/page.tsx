...
export default function PremiumPage() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: 'Защита за вашите проекти с покритие до 5,000 € за всеки проект',
      stats: 'До 5,000 € покритие'
    },
    {
      icon: Users,
      title: 'VIP поддръжка',
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Застраховката покрива до 5,000 € за всеки проект при недовършена работа, закъснения или други проблеми. Покритието е автоматично за всички премиум членове.'
    },
    {
