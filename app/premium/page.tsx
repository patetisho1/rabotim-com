...
export default function PremiumPage() {
  ...
  const benefits = [
    ...
    {
      icon: Star,
      title: 'Видимост в каталога',
      description: 'Профилът ви се показва в каталога "Професионалисти" и може да бъде намерен от клиенти',
      stats: 'Директни запитвания'
    },
    {
      icon: Users,
      title: 'VIP поддръжка',
    ...
    },
    {
      ...
      description: 'Създайте впечатляващ профил с портфолио, сертификати и персонализиран URL',
      stats: 'Личен мини-сайт'
    }
  ]
  ...
  const faqs = [
    {
      ...
      answer: 'Премиум членството включва приоритет в търсенето, промоция на профила, професионален профил с персонализиран URL, разширени статистики, VIP поддръжка и много други функции.'
    },
    {
    ...
    {
      question: 'Какво са промотирани обяви?',
      answer: 'Промотираните обяви се показват на водещи позиции в резултатите от търсенето и в категориите. Basic планът включва 5, Professional - 10, а Enterprise - 20 промотирани обяви месечно.'
    },
    {
    ...
    {
      question: 'Как работи листването в каталога "Професионалисти"?',
      answer: 'Само премиум членовете се показват в каталога с професионалисти. Безплатните акаунти могат да пускат и кандидатстват по обяви, но профилът им не е видим в каталога и не може да бъде намерен чрез търсене. Това е основната разлика между платени и безплатни акаунти.'
    }
  ]
