// Скрипт за създаване на демо данни за тестване
const fs = require('fs')
...
// Записване на демо данните в localStorage (за браузър)
...
// Записване на скрипта
fs.writeFileSync(path.join(__dirname, '..', 'public', 'demo-data.js'), demoDataScript)

console.log('✅ Демо данните са създадени успешно!')
console.log('📁 Файлът е записан в: public/demo-data.js')
console.log('🌐 За да заредите данните, отворете конзолата в браузъра и изпълнете:')
