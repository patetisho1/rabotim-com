...
- [ ] **НЕОБХОДИМО:** Добави RESEND_API_KEY в .env.local
- **Статус:** 🟡 ГОТОВО (чака API key)
- **Защо:** Без emails потребителите забравят платформата

### MVP-2: Seed Data за Demo (КРИТИЧНО)
- [ ] 20-30 реалистични demo задачи
- [ ] Разпределение по категории и локации
- [ ] Demo потребителски профили с рейтинги
- [ ] "Demo" badge на демо обявите
- [ ] Demo данните не блокират реалните
- **Статус:** 🔴 НЕ ЗАПОЧНАТО
- **Защо:** Празният marketplace отблъсква потребители

### MVP-3: Homepage Подобрения
- [ ] Clear value proposition в hero
- [ ] "Как работи" секция с 3 стъпки
- [ ] Показване на активни задачи на homepage
- [ ] CTA бутони с ясни действия
- [ ] Social proof (брой задачи, потребители)
- **Статус:** 🟡 ЧАСТИЧНО (има hero, няма стъпки)
...
- [ ] Report функция за обяви/потребители
- [ ] Block user функция
- [ ] Terms acceptance при регистрация
- **Статус:** 🟡 ЧАСТИЧНО (Terms готови)
