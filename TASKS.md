...
### Homepage Real Data
- [ ] Зареждане на реални статистики от API/Supabase (брой задачи, потребители, градове, завършени)
- [ ] Зареждане на реални задачи за homepage вместо hardcoded данни
- [ ] Зареждане на реални testimonials от базата данни
- [ ] Fallback към placeholder данни ако няма реални
- [ ] Loading states за всички async операции
- **Приоритет:** Среден

### Homepage Testimonials секция
- [ ] Създаване на testimonials таблица в базата данни (ако няма)
- [ ] TestimonialsSection компонент с carousel/grid
- [ ] Реални testimonials с снимки на потребители
- [ ] Истории за успех:
  - "За няколко часа изкарах 150 лв"
  - "Намерих перфектния човек за почистване за 10 минути"
- [ ] CTA бутони "Публикувай обява" / "Започни да печелиш"
- **Приоритет:** Нисък (marketing)
