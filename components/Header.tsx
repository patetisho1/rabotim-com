                      ...
                      <div className="lg:col-span-1">
                        ...
                        <div className="space-y-3">
                          <button 
                            ...
                            className="w-full p-4 text-left bg-gray-50 hover:bg-blue-50 border-l-4 border-transparent hover:border-blue-500 rounded-lg transition-all duration-200"
                          >
                          ...
                          <button 
                            ...
                            className="w-full p-4 text-left bg-blue-50 border-l-4 border-blue-500 rounded-lg transition-all duration-200"
                          >
